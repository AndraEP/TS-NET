    ...
    static class Program
    {
        ...
        static void Main()
        {
            ...
            using (var context = new BusinessContext())
            {
                ...
                Console.WriteLine("\n--- Retail Businesses ---");
                foreach (var r in context.Businesses.OfType<Reatil>())
                {
            ...
            using (var context = new SelfRefContext())
            {
                var newRef = new SelfReference
                {
                    Name = "test1"
                };
                context.SelfReferences.Add(newRef);
                newRef = new SelfReference
                {
                    Name = "test2"
                };
                context.SelfReferences.Add(newRef);
